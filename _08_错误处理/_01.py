#  todo 错误 不是代码bug
#   而是一些执行情况，这些情况会导致程序无法正常执行；
#   也就是建立在代码全部正确的情况下，但是由于一些情况 执行异常
#   那么，我们可以在代码中可以 预处理这些意外情况

#todo 处理方式1. 在知道某些代码可能会出错时，就可以用try来运行这段代码。
#  那么后果就是：
# 如果这段执行出错，则后续try中的后续代码不会继续执行，而是直接跳转至错误处理代码，即except语句块，
# 执行完except后，如果有finally语句块，则执行finally语句块，至此，执行完毕。

# try:
#     print('try...')
#     r=10/0   #这一段可能会出错，放在try里
#     print('result',r)
